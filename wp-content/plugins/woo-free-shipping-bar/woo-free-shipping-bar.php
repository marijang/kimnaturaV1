<?php
/**
 * Plugin Name: Woo Free Shipping Bar
 ...
 */
define( 'VI_WFREESHIPPINGBAR_VERSION', '1.1.0' );
...
if ( ! class_exists( 'WFSPB_F_Shipping' ) ) {
	...
	if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
		...
		define( 'WFSPB_F_SHIPPING_LANGUAGES_DIR', WFSPB_F_SHIPPING_DIR . 'lanuages' . DIRECTORY_SEPARATOR );

		define( 'WFSPB_F_SHIPPING_CSS', WP_PLUGIN_URL . '/woo-free-shipping-bar/assets/css/' );
		define( 'WFSPB_F_SHIPPING_JS', WP_PLUGIN_URL . '/woo-free-shipping-bar/assets/js/' );
		define( 'WFSPB_F_SHIPPING_IMAGES', WP_PLUGIN_URL . '/woo-free-shipping-bar/assets/images/' );
	...
	class WFSPB_F_Shipping {
		...
		public function notification() {
			if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
				...
				<div id="message" class="error">
					<p><?php esc_html_e( 'Please install WooCommerce and active to use Woocommerce Free Shipping Bar plugin !', 'woo-free-shipping-bar' ); ?></p>
				</div>
		...
		public function admin_enqueue_script() {
			...
			if ( $page == 'woo-free-shipping-bar' ) {
				...
				wp_enqueue_style( 'woo-free-shipping-bar-style', WFSPB_F_SHIPPING_CSS . 'woo-free-shipping-bar-admin-style.css' );
				...
				wp_enqueue_script( 'woo-free-shipping-bar-admin', WFSPB_F_SHIPPING_JS . 'woo-free-shipping-bar-admin.js', array( 'jquery' ) );
		...
		public function save_data() {
			...
			$_POST['wfspb-param']['conditional-tags'] = stripslashes( $_POST['wfspb-param']['conditional-tags'] );

			update_option( 'wfspb-param', $_POST['wfspb-param'] );
		...
		public function setting_page_woo_free_shipping_bar() { ?>
			<div class="wrap">
				<h1><?php echo esc_html__( 'WooCommerce Free Shipping Bar', 'woo-free-shipping-bar' ); ?></h1>
				<div class="woo-free-shipping-bar">
					<?php if ( $this->get_woo_shipping_zone() == false ) { ?>
						...
						<div class="vi-ui wfspb-container tab attached bottom segment active" data-tab="general">
							<table class="optiontable form-table">
								<tr valign="top">
									...
									<td>
										<div class="vi-ui toggle checkbox checked">
											<input type="checkbox" name="<?php echo self::set_field( 'enable' ); ?>" <?php checked( self::get_field( 'enable' ), 1 ); ?> value="1">
								...
								<tr valign="top">
									...
									<td>
										<select class="vi-ui fluid dropdown required" name="<?php echo self::set_field( 'default-zone' ); ?>" value="<?php echo htmlentities( self::get_field( 'default-zone' ) ); ?>">
											<?php echo $this->get_default_shipping_zone(); ?>
										</select>
										<p class="description"><?php esc_html_e( 'Please select zone default what you set Free Shiping method.', 'woo-free-shipping-bar' ) ?>(*)require</p>
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php esc_html_e( 'Detect IP', 'woo-free-shipping-bar' ) ?></th>
									<td>
										<a class="vi-ui button" target="_blank" href="https://goo.gl/W6bfKC"><?php esc_html_e( 'Unlock this feature', 'woo-free-shipping-bar' ) ?></a>
						...
						<div class="vi-ui wfspb-container tab attached bottom segment" data-tab="design">
							<table class="optiontable form-table">
								...
								<tr valign="top">
									...
									<td>
										<input type="text" name="<?php echo self::set_field( 'bg-color' ); ?>" value="<?php echo htmlentities( self::get_field( 'bg-color', 'rgb(32, 98, 150)' ) ); ?>">
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php esc_html_e( 'Text Color', 'woo-free-shipping-bar' ) ?></th>
									<td>
										<input type="text" name="<?php echo self::set_field( 'text-color' ); ?>" value="<?php echo htmlentities( self::get_field( 'text-color', '#FFFFFF' ) ); ?>">
									</td>
								</tr>
								<tr valign="top">
									<th scope="row"><?php esc_html_e( 'Link Color', 'woo-free-shipping-bar' ) ?></th>
									<td>
										<input type="text" name="<?php echo self::set_field( 'link-color' ); ?>" value="<?php echo htmlentities( self::get_field( 'link-color', '#77B508' ) ); ?>">
									</td>
								</tr>
								<tr valign="top">
								...
								<tr valign="top">
									...
									<td>
										<select class="vi-ui fluid dropdown select-fontsize" name="<?php echo self::set_field( 'font-size' ); ?>">
								...
								<tr valign="top">
									...
									<td>
										<select class="vi-ui fluid dropdown select-textalign" name="<?php echo self::set_field( 'text-align' ) ?>">
											<option value="left" <?php selected( self::get_field( 'text-align' ), 'left' ) ?>>Left</option>
											<option value="center" <?php selected( self::get_field( 'text-align', 'center' ), 'center' ) ?>>Center</option>
										</select>
									</td>
								</tr>
								<tr valign="top">
									...
									<td>
										<div class="vi-ui toggle checkbox wfspb-enable-progress">
											<input type="checkbox" name="<?php echo self::set_field( 'enable-progress' ); ?>" <?php checked( self::get_field( 'enable-progress' ), 1 ); ?> value="1">
									...
									<td>
										<div class="vi-ui form">
											<div class="three fields">
												<div class="field">
													<img src="<?php echo WFSPB_F_SHIPPING_IMAGES ?>progress-style1.png" class="vi-ui centered medium image middle aligned" />
													<div class="vi-ui toggle checkbox checked center aligned segment">
														<input type="radio" name="<?php echo self::set_field( 'style' ); ?>" <?php checked( self::get_field( 'style', 1 ), 1 ); ?> value="1">
														<label for="<?php echo self::set_field( 'style' ); ?>"><?php esc_html_e( 'Style 1', 'woo-free-shipping-bar' ) ?></label>
													</div>
												</div>
												<div class="field">
													<img src="<?php echo WFSPB_F_SHIPPING_IMAGES ?>progress-style2.png" class="vi-ui centered medium image middle aligned" />
													<div class="vi-ui toggle checkbox checked center aligned segment">
														<input type="radio" name="<?php echo self::set_field( 'style' ); ?>" <?php checked( self::get_field( 'style' ), 2 ); ?> value="2">
														<label for="<?php echo self::set_field( 'style' ); ?>"><?php esc_html_e( 'Style 2', 'woo-free-shipping-bar' ) ?></label>
													</div>
												</div>
												<div class="field">
													<img src="<?php echo WFSPB_F_SHIPPING_IMAGES ?>progress-style3.png" class="vi-ui centered medium image middle aligned" />
													<div class="vi-ui toggle checkbox checked center aligned segment">
														<input type="radio" name="<?php echo self::set_field( 'style' ); ?>" <?php checked( self::get_field( 'style' ), 3 ); ?> value="3">
								...
								<tr valign="top">
									...
									<td>
										<div class="vi-ui form">
											<div class="three fields">
												<div class="field">
													<img src="<?php echo WFSPB_F_SHIPPING_IMAGES ?>position-top.png" class="vi-ui centered large image middle aligned " />
													<div class="vi-ui toggle checkbox checked center aligned segment">
														<input type="radio" name="<?php echo self::set_field( 'position' ); ?>" <?php checked( self::get_field( 'position', 0 ), 0 ); ?> value="0">
														<label for="<?php echo self::set_field( 'position' ); ?>"><?php esc_html_e( 'Top', 'woo-free-shipping-bar' ) ?></label>
													</div>
												</div>
												<div class="field">
													<img src="<?php echo WFSPB_F_SHIPPING_IMAGES ?>position-bottom.png" class="vi-ui centered large image middle aligned " />
													<div class="vi-ui toggle checkbox center aligned segment">
														<input type="radio" name="<?php echo self::set_field( 'position' ); ?>" <?php checked( self::get_field( 'position' ), 1 ); ?> value="1">
							...
							<div id="wfspb-top-bar" class="customized <?php echo esc_attr( $class_pos ) ?>">
								...
								<div id="wfspb-progress" class="<?php echo esc_attr( $class_progress ) ?>" style="display: none">
						...
						<div class="vi-ui wfspb-container tab attached bottom segment" data-tab="message">
							<table class="optiontable form-table">
								<tr valign="top">
									...
									<td>
										<textarea rows="4" name="<?php echo self::set_field( 'announce-system' ); ?>"><?php echo trim( strip_tags( self::get_field( 'announce-system', 'Free shipping for billing over {min_amount}' ) ) ); ?></textarea>
										<ul class="description" style="list-style: none">
											<li>
												<span>{min_amount}</span> - <?php esc_html_e( 'Minimum order amount Free Shipping', 'woo-free-shipping-bar' ) ?>
											</li>
										</ul>
									</td>
								</tr>
								<tr valign="top">
									...
									<td>
										<div class="field">
											<textarea rows="4" name="<?php echo self::set_field( 'message-purchased' ); ?>"><?php echo trim( strip_tags( self::get_field( 'message-purchased', 'You have purchased {total_amounts} of {min_amount}' ) ) ); ?></textarea>
											<ul class="description" style="list-style: none">
												<li>
													<span>{total_amounts}</span> - <?php esc_html_e( 'The total amount of your purchases', 'woo-free-shipping-bar' ) ?>
												</li>
												<li>
													<span>{cart_amount}</span> - <?php esc_html_e( 'Total current cart amount', 'woo-free-shipping-bar' ) ?>
												</li>
												<li>
													<span>{min_amount}</span> - <?php esc_html_e( 'Minimum order amount Free Shipping', 'woo-free-shipping-bar' ) ?>
												</li>
												<li>
													<span>{missing_amount}</span> - <?php esc_html_e( 'The outstanding amount of the free shipping program', 'woo-free-shipping-bar' ) ?>
												</li>
											</ul>
										</div>
									</td>
								...
								<tr valign="top">
									...
									<td>
										<textarea rows="4" name="<?php echo self::set_field( 'message-success' ); ?>"><?php echo trim( strip_tags( self::get_field( 'message-success', 'Congratulation! You have got free shipping. Go to {checkout_page}' ) ) ); ?></textarea>
										<ul class="description" style="list-style: none">
											<li>
												<span>{checkout_page}</span> - <?php esc_html_e( 'Link to checkout page', 'woo-free-shipping-bar' ) ?>
											</li>
								...
								<tr valign="top">
									...
									<td>
										<textarea rows="4" name="<?php echo self::set_field( 'message-error' ); ?>"><?php echo trim( strip_tags( self::get_field( 'message-error', 'You are missing {missing_amount} to get Free Shipping. Continue {shopping}' ) ) ); ?></textarea>
										<ul class="description" style="list-style: none">
											<li>
												<span>{missing_amount}</span> - <?php esc_html_e( 'The outstanding amount of the free shipping program', 'woo-free-shipping-bar' ) ?>
											</li>
											<li>
												<span>{shopping}</span> - <?php esc_html_e( 'Link to shop page', 'woo-free-shipping-bar' ) ?>
											</li>
										</ul>
									</td>
								</tr>
						...
						<div class="vi-ui wfspb-container tab attached bottom segment" data-tab="effect">
							<table class="optiontable form-table">
								...
								<tr valign="top">
									...
									<td>
										<div class="vi-ui toggle checkbox checked">
											<input type="hidden" name="<?php echo self::set_field( 'show-giftbox' ); ?>" value="0" />
											<input type="checkbox" name="<?php echo self::set_field( 'show-giftbox' ); ?>" <?php checked( self::get_field( 'show-giftbox', 1 ), 1 ); ?> value="1" />
		...
		public function get_woo_shipping_zone() {
			global $wpdb;
			$this->check_wooversion();
		...
		public function get_data_atc() {
			$message_success = $this->get_field( 'message-success' );
			$checkout        = '<a href="' . WC()->cart->get_checkout_url() . '" title="' . esc_html__( 'Checkout', 'woo-free-shipping-bar' ) . '">' . esc_html__( 'Checkout', 'woo-free-shipping-bar' ) . '</a>';
			...
			if ( $detect_ip && $this->detect_ip() ) {
				$min_amount = $this->toInt( $this->detect_ip() );
			} elseif ( $default_zone ) {
				$min_amount = $this->toInt( $this->get_min_amount( $default_zone ) );
			} else {
				$min_amount = $this->get_shipping_min_amount();
			}
			...
			$min_percent    = $this->toInt( $min_amount );
			$amount_percent = $this->toInt( $amount );
			...
			$message_purchased = $this->get_field( 'message-purchased' );
		...
		public function get_min_amount_updated_cart_totals() {
			...
			if ( ! WC()->cart->prices_include_tax ) {
				...
				$total_cart = WC()->cart->cart_contents_total + WC()->cart->tax_total;
			}
			if ( $min_amount > $total_cart ) {
		...
		public function check_wooversion() {
